...
- [ ] Mention two parts of Express that you learned about this week.
    I learned about its middleware that adds to its functionality and that is a light framework that helps us build APIs.

- [ ] Describe Middleware?
    Are functions that extend software and used to add features.

- [ ] Describe a Resource?
    Is any data you get back from a HTTP request, can be almost anything.

- [ ] What can the API return to help clients know if a request was successful?
    Status codes

- [ ] How can we partition our application into sub-applications?
    Using routers to break things up based on tasks.
